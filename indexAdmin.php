...
$queryPengguna = mysqli_query($conn, "SELECT * FROM pengguna WHERE role = '1'");
...
$jumlahHasilDiagnosa = mysqli_query($conn, "SELECT COUNT('id_diagnosa') as jml_diagnosa FROM diagnosa");
$diagnosa = mysqli_fetch_assoc($jumlahHasilDiagnosa);
    ...
    <div class="card-body">
        <form method="post" encytpe="multipart/form-data">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                    <a class="badge badge-pill badge-primary" href="editPengguna.php?id_pengguna=<?php echo $data["id_pengguna"]; ?>">edit</a> |
                    <a href="koneksi.php?act=hapusPengguna&id_pengguna=<?= $data["id_pengguna"]; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="badge badge-pill badge-danger">hapus</a>
                    </td>
                    <td><?= $data['nama']; ?></td>
                    <td><?= $data['email']; ?></td>
                    <td><?= $data['nama']; ?></td>
