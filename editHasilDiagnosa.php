...
$id_solusi = $_GET["id_diagnosa"];

$queryPenyakit = mysqli_query($conn, "SELECT * FROM penyakit");

$query = mysqli_query($conn, "SELECT * FROM solusi INNER JOIN penyakit ON solusi.id_penyakit = penyakit.id_penyakit WHERE id_solusi = '$id_solusi'");
