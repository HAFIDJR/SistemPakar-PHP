        ...
        <div class="card-body">
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                        <a class="badge badge-pill badge-primary" href="editKerusakan.php?id_kerusakan=<?php echo $data["id_kerusakan"]; ?>">edit</a> |
                        <a href="koneksi.php?act=hapusKerusakan&id_kerusakan=<?= $data['id_kerusakan']; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="badge badge-pill badge-danger">hapus</a>
                        </td>
