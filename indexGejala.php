...
$queryGejala = mysqli_query($conn, "SELECT * FROM gejala");
        ...
        <div class="card-body">
            <form method="post" encytpe="multipart/form-data">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                        <a class="badge badge-pill badge-primary" href="editGejala.php?id_gejala=<?php echo $data["id_gejala"]; ?>">edit</a> |
                        <a href="koneksi.php?act=hapusGejala&id_gejala=<?= $data['id_gejala']; ?>" onclick="return confirm('Yakin ingin menghapus data?');" class="badge badge-pill badge-danger">hapus</a>
                        </td>
